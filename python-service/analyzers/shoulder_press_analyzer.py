    ...
    try:
        ...
        with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
            while cap.isOpened():
                ...
                if results.pose_landmarks:
                    draw_shoulder_press_stats(image, results.pose_landmarks, stats_data, feedback, active_side)
        ...
        if feedback_list: 
            final_msg += " Not: " + ", ".join(feedback_list)
        
        if correct_reps == 0 and wrong_reps == 0: 
            final_msg = "Hareket algılanamadı."
